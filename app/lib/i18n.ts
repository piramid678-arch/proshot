...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ko: {
    ...
    freeTrialBadge: "무료 체험 2회",
    creditsLeft: "남은 크레딧",
    rechargeButton: "+ 충전",
    paymentModalTitle: "무료 체험 2회까지 가능 🎁",
    paymentModalSubtitle: "월간 구독 없이, 필요한 만큼 1회성 패스를 선택해 바로 생성하세요!",
    pass1Title: "1회 단건 패스",
    pass1Desc: "급하게 증명사진 1장이 필요할 때",
    pass1Price: "2,900원",
    pass3Title: "3회 프로 패스",
    pass3Desc: "다양한 컨셉 화보 & 인화 시트 포함",
    pass3Price: "4,900원",
    pass3Tag: "🔥 가장 인기도 높음",
    pass5Title: "5회 올인원 패스",
    pass5Desc: "비즈니스+증명+아이돌 풀패키지",
    pass5Price: "6,900원",
    paymentMethodLabel: "결제 수단 선택 (월간 자동 결제 ❌)",
    kakaoPay: "카카오페이",
    cardPay: "신용 / 체크카드",
    paypalPay: "PayPal (해외결제)",
    naverPay: "네이버페이",
    paySubmitButton: "단건 결제하고 바로 생성하기",
    paymentSuccessMsg: "결제가 완료되어 크레딧이 충전되었습니다!",
  ...
  en: {
    ...
    // Credits & Payment Modal
    freeTrialBadge: "2 Free Trials",
    creditsLeft: "Credits Left",
    rechargeButton: "+ Buy",
    paymentModalTitle: "Free Trial Up to 2 Times 🎁",
    paymentModalSubtitle: "No monthly subscription! Pick a single pass and generate high-res photos immediately.",
    pass1Title: "1 Single Pass",
    pass1Desc: "Quick 1 photo for ID or passport",
    pass1Price: "$1.99",
    pass3Title: "3 Pro Pass",
    pass3Desc: "Multiple concepts + 4K Print sheet",
    pass3Price: "$3.49",
    pass3Tag: "🔥 Most Popular",
    pass5Title: "5 All-in-One Pass",
    pass5Desc: "Full package for Business, ID & K-pop",
    pass5Price: "$4.99",
    paymentMethodLabel: "Select Payment Method (No Subscription ❌)",
    kakaoPay: "KakaoPay",
    cardPay: "Credit / Debit Card",
    paypalPay: "PayPal / Apple Pay",
    naverPay: "Naver Pay",
    paySubmitButton: "Pay Single Pass & Generate",
    paymentSuccessMsg: "Payment complete! Credits added successfully.",
  ...
  ja: {
    ...
    // Credits & Payment Modal
    freeTrialBadge: "無料体験2回",
    creditsLeft: "残りクレジット",
    rechargeButton: "+ チャージ",
    paymentModalTitle: "無料体験 2回まで可能 🎁",
    paymentModalSubtitle: "月額サブスクなし！必要な分だけ単品パスを選択してすぐ生成できます。",
    pass1Title: "1回単品パス",
    pass1Desc: "急ぎで証明写真が1枚必要な時",
    pass1Price: "￥300",
    pass3Title: "3回プロパス",
    pass3Desc: "多様なコンセプト＋印刷シート付",
    pass3Price: "￥500",
    pass3Tag: "🔥 大人気",
    pass5Title: "5回オールインワン",
    pass5Desc: "ビジネス・証明・K-POPフルセット",
    pass5Price: "￥700",
    paymentMethodLabel: "決済方法を選択（サブスクなし ❌）",
    kakaoPay: "KakaoPay",
    cardPay: "クレジットカード",
    paypalPay: "PayPal / Apple Pay",
    naverPay: "Naver Pay",
    paySubmitButton: "単品決済してすぐ生成",
    paymentSuccessMsg: "決済が完了し、クレジットがチャージされました！",
  ...
  zh: {
    ...
    // Credits & Payment Modal
    freeTrialBadge: "免费体验2次",
    creditsLeft: "剩余积分",
    rechargeButton: "+ 充值",
    paymentModalTitle: "免费体验 最多可试用2次 🎁",
    paymentModalSubtitle: "无需月费订阅！选择单次套餐，立即生成高清 AI 照片。",
    pass1Title: "1次单页套餐",
    pass1Desc: "急需1张证件照或护照照",
    pass1Price: "¥15",
    pass3Title: "3次专业套餐",
    pass3Desc: "多风格概念写真 + 4K打印排版",
    pass3Price: "¥25",
    pass3Tag: "🔥 热门推荐",
    pass5Title: "5次全能套餐",
    pass5Desc: "商务照+证件照+爱豆全套体验",
    pass5Price: "¥35",
    paymentMethodLabel: "选择支付方式（无月费 ❌）",
    kakaoPay: "KakaoPay",
    cardPay: "信用卡 / 借记卡",
    paypalPay: "PayPal / Apple Pay",
    naverPay: "Naver Pay",
    paySubmitButton: "支付套餐并立即生成",
    paymentSuccessMsg: "支付成功！积分已充值到账。",
