...
export const STYLES: StyleDef[] = [
  ...
  },
  {
    ...
    category: "fun",
    label: "K-POP 스타일",
    description: "화려한 무대 의상과 K-POP 앨범 비주얼",
    emoji: "🎤",
    prompt:
      "Transform into a high-energy K-POP artist concept photo: glossy idol hair styling, glamorous K-pop stage makeup, dynamic neon studio lighting with subtle lens flare, iconic K-pop idol album visual outfit.",
  },
  {
    id: "idol",
    category: "fun",
